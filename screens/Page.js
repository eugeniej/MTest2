...
const URL = 'https://www.maiia.com/api/pat-public/hcd?limit=500&locality=75001-PARIS&page=0&speciality.shortName=pharmacie';
    ...
    render() {
        return (
            <View>
                ...
                {this.state.data.map(item => <Text>{item.center.name}</Text>)}
            </View>
        );
    }
};
